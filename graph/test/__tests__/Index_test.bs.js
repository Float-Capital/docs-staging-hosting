...
Curry._2(TestFramework.describe, "All Tests", function(param) {
  Curry._1(param.beforeAll, function(param) {
    ...
    allStateChanges.contents = StateChange.splitIntoEventGroups(
      StateChange.getAllStateChangeEvents(allStateChangesRaw)
    );
  });
  Curry._2(TestFramework.describe, "V1 event", function(param) {
    ...
    return Curry._2(
      testAsync,
      "should setup the correct initial data in the global state",
      function(param) {
        ...
        allStateChanges.contents.then(function(param) {
          ...
          Queries.getGlobalStateAtBlock(match.blockNumber).then(function(
            result
          ) {
            if (result !== undefined) {
              ...
              Curry._2(
                expectEqual,
                result.timestampLaunched.toString(),
                String(timestamp)
              );
  ...
  Curry._2(TestFramework.describe, "SyntheticMarketCreated event", function(
    param
  ) {
    var testAsync = param.testAsync;
    Curry._2(testAsync, "should occur more than ONCE (must test!)", function(
      param
    ) {
      var expectTrue = param.expectTrue;
      var callback = param.callback;
    ...
    Curry._2(
      testAsync,
      "synthetic market shouldn't exist before this event is emitted",
      function(param) {
        var expectTrue = param.expectTrue;
        var callback = param.callback;
        allStateChanges.contents
          .then(function(param) {
            return Promise.all(
              Belt_Array.map(param.allSyntheticMarketCreatedEvents, function(
                param
              ) {
                return Queries.getSyntheticMarketAtBlock(
                  param.data.marketIndex.toString(),
                  (param.blockNumber - 1) | 0
    ...
    Curry._2(
      testAsync,
      "should create a SyntheticMarket with correct ID and initial data",
      function(param) {
        var expectEqual = param.expectEqual;
        var expectTrue = param.expectTrue;
        var callback = param.callback;
              ...
              Belt_Array.map(param.allSyntheticMarketCreatedEvents, function(
                ...
                return Queries.getSyntheticMarketAtBlock(
                  ...
                  Curry._2(
                    expectEqual,
                    String(timestamp),
                    result.timestampCreated.toString()
                  );
                  Curry._2(expectEqual, txHash, result.txHash);
                  Curry._2(
                    expectEqual,
                    String(blockNumber),
                    result.blockNumberCreated.toString()
                  );
                  ...
                  Curry._2(
                    expectEqual,
                    result.syntheticLong.id,
                    longTokenAddress
                  );
                  Curry._2(
                    expectEqual,
                    result.syntheticShort.id,
                    shortTokenAddress
                  );
                  Curry._2(
                    expectEqual,
                    result.latestSystemState.id,
                    marketIndex.toString() + "-0"
                  );
                  Curry._2(
                    expectEqual,
                    result.feeStructure.id,
                    marketIndex.toString() + "-fees"
                  );
                  return Curry._2(
                    expectEqual,
                    result.collateralToken.id,
                    collateralAddress
                  );
                });
              })
    ...
    var testSyntheticToken = function(
      syntheticTokenQuery,
      tokenAddress,
      timestamp,
      marketIndex,
      ...
      Curry._2(
        expectEqual,
        syntheticTokenQuery.syntheticMarket.id,
        marketIndex.toString()
      );
      Curry._2(expectEqual, syntheticTokenQuery.tokenType, tokenStrTypeUpper);
      Curry._2(
        expectEqual,
        syntheticTokenQuery.floatMintedFromSpecificToken.toString(),
        "0"
      );
      Curry._2(
        expectEqual,
        syntheticTokenQuery.latestStakerState.id,
        tokenAddress + "-0"
      );
      Curry._2(
        expectEqual,
        match.id,
        "latestPrice-" + marketIndex.toString() + "-" + tokenStrTypeLower
      );
      Curry._2(
        expectEqual,
        match.price.id,
    ...
    return Curry._2(
      testAsync,
      "should create SyntheticTokens with correct IDs and initial data",
      function(param) {
        var expectEqual = param.expectEqual;
        var expectTrue = param.expectTrue;
        var callback = param.callback;
  ...
  return Curry._2(
    param.testAsync,
    "All events should be classified - NO UNKNOWN EVENTS",
    function(param) {
      var expectEqual = param.expectEqual;
      var callback = param.callback;
      allStateChanges.contents.then(function(param) {
