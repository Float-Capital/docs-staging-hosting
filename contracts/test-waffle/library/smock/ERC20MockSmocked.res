...
@send @scope("getRoleMember")
external mockGetRoleMemberToReturn: (t, Ethers.ethAddress) => unit = "returns"
...
let getRoleMemberOld: t => array<getRoleMemberCall> = _r => {
  let array = %raw("_r.getRoleMember.calls")
...
@send @scope(("to", "have", "been"))
external getRoleMemberCalledWith: (expectation, string, Ethers.BigNumber.t) => unit = "calledWith"

@get external getRoleMemberFunction: t => string = "getRoleMember"

let getRoleMemberCallCheck = (contract, {role, index}: getRoleMemberCall) => {
  expect(contract->getRoleMemberFunction)->getRoleMemberCalledWith(role, index)
}

@send @scope("getRoleMember")
external mockGetRoleMemberToRevert: (t, ~errorString: string) => unit = "returns"

@send @scope("getRoleMember")
external mockGetRoleMemberToRevertNoReason: t => unit = "reverts"

@send @scope("getRoleMemberCount")
external mockGetRoleMemberCountToReturn: (t, Ethers.BigNumber.t) => unit = "returns"

type getRoleMemberCountCall = {role: string}

let getRoleMemberCountOld: t => array<getRoleMemberCountCall> = _r => {
  let array = %raw("_r.getRoleMemberCount.calls")
  array->Array.map(_m => {
    let role = _m->Array.getUnsafe(0)
...
@send @scope(("to", "have", "been"))
external getRoleMemberCountCalledWith: (expectation, string) => unit = "calledWith"

@get external getRoleMemberCountFunction: t => string = "getRoleMemberCount"

let getRoleMemberCountCallCheck = (contract, {role}: getRoleMemberCountCall) => {
  expect(contract->getRoleMemberCountFunction)->getRoleMemberCountCalledWith(role)
}

@send @scope("getRoleMemberCount")
external mockGetRoleMemberCountToRevert: (t, ~errorString: string) => unit = "returns"

@send @scope("getRoleMemberCount")
external mockGetRoleMemberCountToRevertNoReason: t => unit = "reverts"
...
let setShouldMockTransferOld: t => array<setShouldMockTransferCall> = _r => {
  let array = %raw("_r.setShouldMockTransfer.calls")
  array->Array.map(_m => {
...
@send @scope(("to", "have", "been"))
external setShouldMockTransferCalledWith: (expectation, bool) => unit = "calledWith"

@get external setShouldMockTransferFunction: t => string = "setShouldMockTransfer"

let setShouldMockTransferCallCheck = (contract, {value}: setShouldMockTransferCall) => {
  expect(contract->setShouldMockTransferFunction)->setShouldMockTransferCalledWith(value)
}

@send @scope("setShouldMockTransfer")
external mockSetShouldMockTransferToRevert: (t, ~errorString: string) => unit = "returns"

@send @scope("setShouldMockTransfer")
external mockSetShouldMockTransferToRevertNoReason: t => unit = "reverts"
