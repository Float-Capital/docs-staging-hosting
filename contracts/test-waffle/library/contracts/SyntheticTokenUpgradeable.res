...
let contractName = "SyntheticTokenUpgradeable"
...
let make: unit => JsPromise.t<t> = () => deployContract0(contractName)->Obj.magic
  ...
  @send
  external initialize: (
    t,~name: string,~symbol: string,~longShort: Ethers.ethAddress,~staker: Ethers.ethAddress,~marketIndex: int,~isLong: bool,
