...
let make: unit => JsPromise.t<t> = () => deployContract0(contractName)->Obj.magic
  ...
  @send
  external createNewSyntheticMarketExternalSyntheticTokens: (
    t,~syntheticName: string,~syntheticSymbol: string,~longToken: Ethers.ethAddress,~shortToken: Ethers.ethAddress,~paymentToken: Ethers.ethAddress,~oracleManager: Ethers.ethAddress,~yieldManager: Ethers.ethAddress,
  ...
  @send
  external initialize: (
    t,~admin: Ethers.ethAddress,~tokenFactory: Ethers.ethAddress,~staker: Ethers.ethAddress,
...
short_changeInMarketValue_inPaymentToken: Ethers.BigNumber.t,
  ...
  external _claimAndDistributeYieldThenRebalanceMarketExposed: (
    t,~marketIndex: int,~newAssetPrice: Ethers.BigNumber.t,
...
treasuryYieldPercent_e18: Ethers.BigNumber.t,
  ...
  @send
  external setPerformOutstandingBatchedSettlementsGlobals: (
  ...
  ) => JsPromise.t<transaction> = "setPerformOutstandingBatchedSettlementsGlobals"
