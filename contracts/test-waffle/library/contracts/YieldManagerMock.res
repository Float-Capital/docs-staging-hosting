...
let make: (~longShort: Ethers.ethAddress,~treasury: Ethers.ethAddress,~token: Ethers.ethAddress,) => JsPromise.t<t> = (~longShort,~treasury,~token,) =>
    ...
    let makeSmock: (~longShort: Ethers.ethAddress,~treasury: Ethers.ethAddress,~token: Ethers.ethAddress,) => JsPromise.t<t> = (~longShort,~treasury,~token,) =>
    deployMockContract3(contractName, longShort,treasury,token,)->Obj.magic
