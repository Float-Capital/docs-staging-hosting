...
@send
external burn: (t, ~amount: Ethers.BigNumber.t) => JsPromise.t<transaction> = "burn"
...
@send
external getRoleAdmin: (t, ~role: bytes32) => JsPromise.t<getRoleAdminReturn> = "getRoleAdmin"
...
@send
external getRoleMemberCount: (t, ~role: bytes32) => JsPromise.t<getRoleMemberCountReturn> =
  "getRoleMemberCount"

@send
external grantRole: (t, ~role: bytes32, ~account: Ethers.ethAddress) => JsPromise.t<transaction> =
  "grantRole"

type hasRoleReturn = bool
@send
external hasRole: (t, ~role: bytes32, ~account: Ethers.ethAddress) => JsPromise.t<hasRoleReturn> =
  "hasRole"
...
@send
external marketIndex: t => JsPromise.t<marketIndexReturn> = "marketIndex"
...
@send
external pause: t => JsPromise.t<transaction> = "pause"

type pausedReturn = bool
@send
external paused: t => JsPromise.t<pausedReturn> = "paused"
...
@send
external stake: (t, ~amount: Ethers.BigNumber.t) => JsPromise.t<transaction> = "stake"
...
@send
external unpause: t => JsPromise.t<transaction> = "unpause"
