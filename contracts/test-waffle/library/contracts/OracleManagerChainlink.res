...
let make: (~admin: Ethers.ethAddress, ~chainLinkOracle: Ethers.ethAddress) => JsPromise.t<t> = (
  ~admin,
  ~chainLinkOracle,
...
@send
external chainlinkOracle: t => JsPromise.t<chainlinkOracleReturn> = "chainlinkOracle"
...
@send
external getLatestPrice: t => JsPromise.t<getLatestPriceReturn> = "getLatestPrice"

type oracleDecimalsReturn = int
@send
external oracleDecimals: t => JsPromise.t<oracleDecimalsReturn> = "oracleDecimals"

@send
external updatePrice: t => JsPromise.t<transaction> = "updatePrice"

type updatePriceReturn = Ethers.BigNumber.t
@send @scope("callStatic")
external updatePriceCall: t => JsPromise.t<updatePriceReturn> = "updatePrice"
