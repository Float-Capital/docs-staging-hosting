...
function testUnit(contracts, accounts) {
                  ...
                  it("calls _shiftPositionNextPrice with isShiftFromLong==true", (function () {
                          return LetOps.Await.let_(LongShortSmocked.InternalMock.setupFunctionForUnitTesting(contracts.contents.longShort, "shiftPositionFromLongNextPrice"), (function (param) {
                                        return LetOps.Await.let_(contracts.contents.longShort.shiftPositionFromLongNextPrice(1, amountSyntheticTokensToShift), (function (param) {
                                                      return LongShortSmocked.InternalMock.shiftPositionNextPriceCallCheck({
                                                                  marketIndex: 1,
  ...
  describe("shiftPositionNextPrice function", (function () {
          ...
          var shiftPositionNextPriceExposedTxRef = {
            contents: "Not defined yet"
          };
          var testMarketSide = function (isShiftFromLong) {
            Globals.before_once$p(function (param) {
                  ...
                  return LetOps.AwaitThen.let_(SyntheticTokenSmocked.make(undefined), (function (longSynthSmocked) {
                                longSynthSmocked.transferFrom.returns(true);
                                ...
                                return LetOps.AwaitThen.let_(LongShortSmocked.InternalMock.setup(longShort), (function (param) {
                                              return LetOps.AwaitThen.let_(LongShortSmocked.InternalMock.setupFunctionForUnitTesting(longShort, "shiftPositionNextPrice"), (function (param) {
                                                            return LetOps.AwaitThen.let_(longShort.setShiftNextPriceGlobals(1, marketUpdateIndex, longSynthSmocked.address, isShiftFromLong), (function (param) {
                                                                          ...
                                                                          shiftPositionNextPriceExposedTxRef.contents = longShort$1.shiftPositionNextPrice(1, amount, isShiftFromLong);
                                                                          return shiftPositionNextPriceExposedTxRef.contents;
                                                                        }));
                                                          }));
                                            }));
                              }));
            ...
            it("emits the NextPriceSyntheticPositionShift event", (function () {
                    var testWallet = accounts.contents[1];
                    return Chai.callEmitEvents(shiftPositionNextPriceExposedTxRef.contents, contracts.contents.longShort, "NextPriceSyntheticPositionShift").withArgs(1, isShiftFromLong, amount, testWallet.address, Globals.add(marketUpdateIndex, Globals.oneBn));
                  }));
            it("transfers synthetic tokens (calls transferFrom with the correct parameters)", (function () {
                    var testWallet = accounts.contents[1];
                    return SyntheticTokenSmocked.transferFromCallCheck(smockedSyntheticToken.contents, {
