...
let testUnit =
  ...
  describe_only("Execute next price action", () => {
    ...
    describe("_executeOutstandingNextPriceMints", () => {
      ...
      describe("userNextPriceDepositAmount == 0", () => {
        let executeOutstandingNextPriceMintsTx = ref("Undefined"->Obj.magic);
        let isLong = true;
        ...
        it("should not emit the ExecuteNextPriceMintSettlementUser event", () => {
          Chai.callEmitEvents(
      ...
      describe("userNextPriceDepositAmount > 0", () => {
        ...
        it("should reset userNextPriceDepositAmount to zero", () => {
          let%Await userNextPriceDepositAmount =
            contracts.contents.longShort
            ->LongShort.userNextPriceDepositAmount(marketIndex, isLong, user);
