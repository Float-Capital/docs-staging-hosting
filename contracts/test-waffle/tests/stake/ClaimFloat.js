...
var smockedCalcAccumIterativeBinding = ((_r, arr) => _r._calculateAccumulatedFloatAndExecuteOutstandingShiftsMock.returns(makeIterator(arr)));
...
function test(contracts, accounts) {
  describe("_mintAccumulatedFloatAndExecuteOutstandingShiftsMulti", (function () {
          var marketIndices = [
          ...
          var setup = function (marketIndices, latestRewardIndices, floatRewardsForMarkets) {
            ...
            return LetOps.Await.let_(StakerSmocked.InternalMock.setupFunctionForUnitTesting(match.staker, "_mintAccumulatedFloatAndExecuteOutstandingShiftsMulti"), (function (param) {
                          ...
                          return LetOps.Await.let_(Belt_Array.reduceWithIndex(marketIndices, Promise.resolve(undefined), (function (lastPromise, marketIndex, arrayIndex) {
                                        ...
                                        promiseRef.contents = contracts.contents.staker.connect(userWalletRef.contents)._mintAccumulatedFloatAndExecuteOutstandingShiftsMultiExposed(marketIndices, userWalletRef.contents.address);
