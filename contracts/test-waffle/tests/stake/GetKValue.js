...
function test(contracts, param) {
  ...
  describe("getKValue", (function () {
          ...
          var setup = function (multiplier, periodShouldBeOver) {
            return LetOps.AwaitThen.let_(StakerSmocked.InternalMock.setupFunctionForUnitTesting(contracts.contents.staker, "getKValue"), (function (param) {
          ...
          describe("", (function () {
                  ...
                  it("calls getMarketLaunchIncentiveParameters with correct arguments", (function () {
                          return StakerSmocked.InternalMock._getMarketLaunchIncentiveParametersCallCheck({
                                      marketIndex: 2
                                    });
                        }));
