...
function testUnit(contracts, accounts) {
  ...
  var commonTestsBetween_claimFloatCustomANDclaimFloatCustomFor = function (getUser) {
    it("calls LongShort.updateSystemStateMulti for the markets", (function () {
            return LongShortSmocked.updateSystemStateMultiCallCheck(contracts.contents.longShortSmocked, {
                        marketIndexes: marketIndices
                      });
          }));
    it("calls _mintAccumulatedFloatAndExecuteOutstandingShiftsMulti with the correct arguments", (function () {
            return StakerSmocked.InternalMock._mintAccumulatedFloatAndExecuteOutstandingShiftsMultiCallCheck({
                        marketIndexes: marketIndices,
