...
function testUnit(contracts, accounts) {
  return Globals.describeUnit("Withdraw functions", (function (param) {
                ...
                describe.skip("_withdraw", (function () {
                        var userWallet = {
                          contents: undefined
                        };
                        ...
                        var setup = function (amountStaked) {
                          ...
                          return LetOps.Await.let_(staker.set_withdrawGlobals(marketIndex, syntheticTokenSmocked.address, userWallet.contents.address, amountStaked, fees, treasury), (function (param) {
                                        syntheticTokenSmocked.transfer.returns(true);
                        ...
                        describe("happy case", (function () {
                                ...
                                it("calls transfer on the synthetic token with correct args", (function () {
                                        ...
                                        SyntheticTokenSmocked.transferCallCheck(contracts.contents.syntheticTokenSmocked, {
                                              recipient: treasury,
                                              amount: fees$1
                                            });
                                        return SyntheticTokenSmocked.transferCallCheck(contracts.contents.syntheticTokenSmocked, {
                                                    recipient: userWallet.contents.address,
                                                    amount: Globals.sub(amountWithdrawn, fees$1)
                                                  });
                                      }));
                                it("calls _mintAccumulatedFloatAndExecuteOutstandingShifts with correct args", (function () {
                        ...
                        describe("sad case", (function () {
                                Globals.before_once$p(function (param) {
                                      return setup(Globals.sub(amountWithdrawn, Globals.oneBn));
                                    });
                                it("reverts if nothing to withdraw", (function () {
                                        return Chai.expectRevert(call.contents, "not enough to withdraw");
                                      }));
                ...
                describe.skip("withdraw", (function () {
                        ...
                        Globals.before_once$p(function (param) {
                              return LetOps.AwaitThen.let_(contracts.contents.staker.setWithdrawGlobals(marketIndex, contracts.contents.longShortSmocked.address, token), (function (param) {
                                            return contracts.contents.staker.withdraw(marketIndex, true, amountWithdrawn);
                                          }));
                            });
                        it("calls updateSystemState on longShort with correct args", (function () {
                                return LongShortSmocked.updateSystemStateCallCheck(contracts.contents.longShortSmocked, {
                                            marketIndex: marketIndex
                                          });
                              }));
                        it("calls _withdraw with correct args", (function () {
                                return StakerSmocked.InternalMock._withdrawCallCheck({
                                            marketIndex: marketIndex,
                                            token: token,
                                            amount: amountWithdrawn
                                          });
                              }));
                        it("should not allow shifts > userAmountStaked", (function () {
                                var adminWallet = accounts.contents[0];
                                return LetOps.Await.let_(contracts.contents.staker.connect(adminWallet).setWithdrawAllGlobals(marketIndex, contracts.contents.longShortSmocked.address, adminWallet.address, Globals.bnFromInt(0), token, Globals.bnFromInt(777), token, Helpers.randomTokenAmount(undefined), Helpers.randomTokenAmount(undefined)), (function (param) {
                                              return Chai.expectRevert(contracts.contents.staker.connect(adminWallet).withdraw(marketIndex, true, amountWithdrawn), "Outstanding next price stake shifts too great");
                                            }));
                              }));
                        
                      }));
                describe.skip("withdrawAll", (function () {
                        var token = Helpers.randomAddress(undefined);
                        var userWallet = {
                          contents: undefined
                        };
                        Globals.before_once$p(function (param) {
                              userWallet.contents = accounts.contents[5];
                              return LetOps.AwaitThen.let_(contracts.contents.staker.setWithdrawAllGlobals(marketIndex, contracts.contents.longShortSmocked.address, userWallet.contents.address, amountStaked, token, Globals.bnFromInt(1), Helpers.randomAddress(undefined), Globals.bnFromInt(0), Globals.bnFromInt(0)), (function (param) {
                                            return contracts.contents.staker.connect(userWallet.contents).withdrawAll(marketIndex, true);
                                          }));
                            });
                        it("calls updateSystemState on longShort with correct args", (function () {
                                return LongShortSmocked.updateSystemStateCallCheck(contracts.contents.longShortSmocked, {
