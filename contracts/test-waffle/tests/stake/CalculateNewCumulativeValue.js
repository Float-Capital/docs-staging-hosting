...
function test(contracts, param) {
  ...
  describe("calculateNewCumulativeValue", (function () {
          ...
          Globals.before_once$p(function (param) {
                ...
                return LetOps.AwaitThen.let_(StakerSmocked.InternalMock.setupFunctionForUnitTesting(staker, "calculateNewCumulativeValue"), (function (param) {
                              ...
                              return LetOps.Await.let_(staker.setCalculateNewCumulativeRateParams(marketIndex, latestRewardIndexForMarket, accumFloatLong, accumFloatShort), (function (param) {
                                            promiseRef.contents = staker._calculateNewCumulativeIssuancePerStakedSynthExposed(marketIndex, latestRewardIndexForMarket, longPrice, shortPrice, longValue, shortValue);
          ...
          it("calls calculateFloatPerSecond with correct arguments", (function () {
                  return StakerSmocked.InternalMock._calculateFloatPerSecondCallCheck({
          ...
          it("calls calculateTimeDelta with correct arguments", (function () {
                  return StakerSmocked.InternalMock._calculateTimeDeltaFromLastAccumulativeIssuancePerStakedSynthSnapshotCallCheck({
                              marketIndex: marketIndex,
