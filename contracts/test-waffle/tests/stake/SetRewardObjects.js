...
function test(contracts, accounts) {
  ...
  describe("setRewardObjects", (function () {
          ...
          it("calls calculateNewCumulativeRate with correct arguments", (function () {
                  return Chai.recordEqualFlat(Belt_Array.getExn(StakerSmocked.InternalMock.calculateNewCumulativeRateCalls(undefined), 0), {
