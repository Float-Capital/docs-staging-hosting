...
contract LongShortForInternalMocking {
    ...
    function _getSyntheticTokenPriceMock(uint32, bool)
        public
        pure
    ...
    function _getAmountSynthTokenMock(uint256, uint256)
        public
        pure
        returns (uint256)
    {
    ...
    function getUsersConfirmedButNotSettledBalanceMock(
        address,
        uint32,
        bool
    ...
    function getMarketPcntForTreasuryVsMarketSplitMock(uint32)
        public
        pure
    ...
    function getLongPcntForLongVsShortSplitMock(uint32)
        public
        pure
    ...
    function _saveSyntheticTokenPriceSnapshotsMock(
        uint32,
        uint256,
        uint256,
        uint256
    ...
    function _burnSynthTokensForRedemptionMock(
        uint32,
        uint256,
        uint256
    ) public pure {
    ...
    function _performOustandingSettlementsMock(
        uint32,
        uint256,
        uint256,
        uint256
    ...
    function _handleBatchedDepositSettlementMock(
        uint32,
        bool,
        uint256
    ) public pure {
    ...
    function _handleBatchedRedeemSettlementMock(
        uint32,
        uint256,
        uint256
    ) public pure {
