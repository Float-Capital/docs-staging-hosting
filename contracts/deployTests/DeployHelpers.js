...
function redeemNextPrice(amount, marketIndex, longShort, user, isLong) {
  var redeemFunction = isLong ? (function (prim, prim$1, prim$2) {
        return prim.redeemLongNextPrice(prim$1, prim$2);
      }) : (function (prim, prim$1, prim$2) {
        return prim.redeemShortNextPrice(prim$1, prim$2);
      });
...
function mintNextPrice(amount, marketIndex, paymentToken, longShort, user, isLong) {
  return LetOps.AwaitThen.let_(paymentToken.connect(user).approve(longShort.address, amount), (function (param) {
                var mintFunction = isLong ? (function (prim, prim$1, prim$2) {
                      return prim.mintLongNextPrice(prim$1, prim$2);
                    }) : (function (prim, prim$1, prim$2) {
                      return prim.mintShortNextPrice(prim$1, prim$2);
                    });
