                                                                                                                                                                                        ...
                                                                                                                                                                                        return LetOps.AwaitThen.let_(priceAndStateUpdate(undefined), (function (param) {
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      return LetOps.AwaitThen.let_(DeployHelpers.executeOnMarkets(initialMarkets, (function (__x) {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    return LetOps.AwaitThen.let_(priceAndStateUpdate(undefined), (function (param) {
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  return LetOps.AwaitThen.let_(DeployHelpers.executeOnMarkets(initialMarkets, (function (__x) {
                                                                                                                                                                                                                                                    return DeployHelpers.shiftStakeNextPriceWithSystemUpdate(longShiftAmount, true, __x, longShort, staker, user1, admin);
                                                                                                                                                                                                                                                  })), (function (param) {
                                                                                                                                                                                                                                                return LetOps.AwaitThen.let_(priceAndStateUpdate(undefined), (function (param) {
                                                                                                                                                                                                                                                              return LetOps.AwaitThen.let_(DeployHelpers.executeOnMarkets(initialMarkets, (function (__x) {
                                                                                                                                                                                                                                                                                return DeployHelpers.mintLongNextPriceWithSystemUpdate(Globals.bnFromInt(0), __x, paymentToken, longShort, user1, admin);
                                                                                                                                                                                                                                                                              })), (function (param) {
                                                                                                                                                                                                                                                                            return LetOps.AwaitThen.let_(DeployHelpers.executeOnMarkets(initialMarkets, (function (__x) {
                                                                                                                                                                                                                                                                                              return DeployHelpers.mintShortNextPriceWithSystemUpdate(Globals.bnFromInt(0), __x, paymentToken, longShort, user1, admin);
                                                                                                                                                                                                                                                                                            })), (function (param) {
                                                                                                                                                                                                                                                                                          return LetOps.AwaitThen.let_(DeployHelpers.executeOnMarkets(initialMarkets, (function (__x) {
                                                                                                                                                                                                                                                                                                            return DeployHelpers.mintLongNextPriceWithSystemUpdate(Globals.bnFromInt(0), __x, paymentToken, longShort, user2, admin);
                                                                                                                                                                                                                                                                                                          })), (function (param) {
                                                                                                                                                                                                                                                                                                        return LetOps.AwaitThen.let_(DeployHelpers.executeOnMarkets(initialMarkets, (function (__x) {
                                                                                                                                                                                                                                                                                                                          return DeployHelpers.mintLongNextPriceWithSystemUpdate(Globals.bnFromInt(0), __x, paymentToken, longShort, user8, admin);
                                                                                                                                                                                                                                                                                                                        })), (function (param) {
                                                                                                                                                                                                                                                                                                                      return LetOps.AwaitThen.let_(DeployHelpers.executeOnMarkets(initialMarkets, (function (marketIndex) {
                                                                                                                                                                                                                                                                                                                                        return longShort.connect(user7).mintLongNextPrice(marketIndex, Globals.bnFromInt(0));
                                                                                                                                                                                                                                                                                                                                      })), (function (param) {
                                                                                                                                                                                                                                                                                                                                    return LetOps.AwaitThen.let_(priceAndStateUpdate(undefined), (function (param) {
