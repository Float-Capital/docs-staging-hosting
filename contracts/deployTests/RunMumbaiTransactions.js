...
function runMumbaiTransactions(param, deploymentArgs) {
  ...
  return LetOps.AwaitThen.let_(Curry._1(deploymentArgs.getNamedAccounts, undefined), (function (namedAccounts) {
                return LetOps.AwaitThen.let_(ethers.getSigners(), (function (loadedAccounts) {
                              var deployer = loadedAccounts[0];
                              var admin = loadedAccounts[1];
                              var user1 = loadedAccounts[2];
                              var user2 = loadedAccounts[3];
                              var user3 = loadedAccounts[4];
                              return LetOps.AwaitThen.let_(DeployHelpers.topupBalanceIfLow(deployer, admin), (function (param) {
                                            return LetOps.AwaitThen.let_(DeployHelpers.topupBalanceIfLow(deployer, user1), (function (param) {
                                                          return LetOps.AwaitThen.let_(DeployHelpers.topupBalanceIfLow(deployer, user2), (function (param) {
                                                                        return LetOps.AwaitThen.let_(DeployHelpers.topupBalanceIfLow(deployer, user3), (function (param) {
