...
const createSynthetic = async (
  ...
  const longAddress = await longShort.syntheticTokens.call(true, currentMarketIndex);
  const shortAddress = await longShort.syntheticTokens.call(false, currentMarketIndex);
