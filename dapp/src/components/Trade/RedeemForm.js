...
function RedeemForm(Props) {
  ...
  var match$7 = form.input.isMint;
  var match$8 = form.input.isLong;
  var match$9;
  if (match$7) {
  ...
  var optAdditionalErrorMessage = match$9[0];
  ...
  if (form.input.isMint) {
    var match$10 = form.amountResult;
    var tmp$1;
    var exit$1 = 0;
    var message;
    ...
    tmp = React.createElement(React.Fragment, undefined, React.createElement(AmountInput.make, {
              placeholder: "mint",
