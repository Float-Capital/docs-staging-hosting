...
function UserUI$UserMarketUnstake(Props) {
  ...
  var showUnstakeModal = Belt_Option.mapWithDefault(Js_dict.get(router.query, "unstake"), false, (function (address) {
          return address === synthAddressStr;
        }));
  var openUnstakeModal = function (param) {
    router.query["unstake"] = synthAddressStr;
    return Next.Router.pushObjShallow(router, {
                pathname: router.pathname,
                query: router.query
              });
  };
  var closeUnstakeModal = function (param) {
    Js_dict.unsafeDeleteKey(router.query, "unstake");
    return Next.Router.pushObjShallow(router, {
                pathname: router.pathname,
                query: router.query
              });
