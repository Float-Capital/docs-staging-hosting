...
function TokenBalance(Props) {
  ...
  return React.createElement(React.Fragment, undefined, optBalance !== undefined ? React.createElement("p", undefined, FormatMoney.formatMoney(Belt_Option.getWithDefault(Belt_Float.fromString(Ethers.Utils.formatEther(Caml_option.valFromOption(optBalance))), 0))) : React.createElement(MiniLoader.make, {}));
}
