...
function marketPositionValues(
  ...
  var longBeta = calculateBeta(
    totalValueLocked,
    totalLockedLong,
    totalLockedShort,
    true
  );
  var shortBeta = calculateBeta(
    totalValueLocked,
    totalLockedLong,
    totalLockedShort,
    false
  );
  var value = Misc.NumberFormat.formatEther(
    undefined,
    isLong ? totalLockedLong : totalLockedShort
  );
  ...
  return React.createElement(
    ...
    React.createElement(Button.Small.make, {
      onClick: function ($$event) {
        ...
        return Next.Router.pushShallow(
          router,
          "/mint?marketIndex=" + marketIndex.toString() + "&actionOption=long"
        );
      },
      children: "Mint Long",
    }),
    React.createElement(Button.Small.make, {
      onClick: function ($$event) {
        ...
        return Next.Router.pushShallow(
          router,
          "/mint?marketIndex=" + marketIndex.toString() + "&actionOption=short"
        );
      },
      children: "Mint Short",
    })
...
function liquidityRatio(totalValueLocked, totalLockedLong) {
  return React.createElement(
    ...
    totalValueLocked.eq(CONSTANTS.zeroBN)
      ? null
      : React.createElement(MarketBar.make, {
...
function MarketCard(Props) {
  ...
  return React.createElement(Link, {
    ...
    children: React.createElement(
      ...
      {
        className:
          "p-1 rounded-lg flex flex-col bg-white bg-opacity-75 hover:bg-opacity-60 cursor-pointer shadow-lg hover:shadow-xl h-full justify-center w-full",
      },
      React.createElement(
        "div",
        {
        ...
        React.createElement(
          ...
          {
            className:
              "font-bold text-xl font-alphbeta cursor-pointer hover:underline",
          },
          marketName,
          React.createElement(Tooltip.make, {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "order-2 md:order-1 w-1/2 md:w-1/4 flex items-center flex grow flex-wrap flex-col",
          },
          marketPositionHeadings(true),
          React.createElement(
            "div",
            {
        ...
        React.createElement(
          ...
          {
            className:
              "order-1 md:order-2 w-full md:w-1/2 flex items-center flex-col",
          },
          React.createElement(
            "h2",
            {
          ...
          React.createElement(
            ...
            liquidityRatio(totalValueLocked, totalLockedLong),
    ...
    children: React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "order-2  w-1/2  flex items-center flex grow flex-wrap flex-col",
          },
          marketPositionHeadings(true)
        ),
        React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          liquidityRatio(totalValueLocked, match.totalLockedLong)
        ),
        mintButtons(marketIndex)
      )
    ),
