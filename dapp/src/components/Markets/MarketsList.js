  ...
  return React.createElement(React.Fragment, undefined, React.createElement("div", {
                  className: "p-1 mb-8 rounded-lg flex flex-col bg-white bg-opacity-75 my-5 shadow-lg"
                      ...
                      className: "block md:hidden pt-5"
                        ...
                        }, marketPositionValues(true), marketPositionValues(false)), mintButtons(undefined))), Belt_Option.mapWithDefault(marketIndexOption, null, (function (queryMarketIndex) {
                    if (queryMarketIndex === marketIndex.toString()) {
                      return React.createElement(Mint.Mint.make, {});
                    } else {
                      return null;
                    }
                  })));
