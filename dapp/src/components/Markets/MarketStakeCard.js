                  ...
                  className: "flex flex-wrap justify-center w-full"
                      ...
                      className: "w-full md:w-1/2 flex items-center justify-center flex-col order-1 md:order-2"
                          ...
                          className: "flex flex-row items-center justify-between w-full mb-4"
                                ...
                                }, "$" + FormatMoney.formatEther(undefined, totalLockedLong))), React.createElement("div", undefined, React.createElement("div", undefined, React.createElement("h2", {
                              ...
                              className: "text-right"
                                  ...
                                  className: "text-xs font-alphbeta tracking-wider py-1 text-gray-600"
                                }, "$" + FormatMoney.formatEther(undefined, totalLockedShort)))), React.createElement("div", {
                          className: "w-full"
