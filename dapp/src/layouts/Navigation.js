  ...
  if (optCurrentUser !== undefined) {
    ...
    tmp = React.createElement(Link, {
      ...
      children: React.createElement(
        ...
        {
          className:
            "px-3 bg-white hover:bg-black hover:text-gray-200 text-base cursor-pointer",
        },
        " 👤 ",
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Link, {
        ...
        children: React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                "text-xl text-green-800 ml-2 align-middle font-semibold",
            },
            React.createElement(
              "div",
              {
      ...
      React.createElement(
        ...
        {
          className:
            "flex w-2/3 text-base items-center justify-end visible md:hidden",
        },
        React.createElement(
          "div",
          {
...
export { floatingMenuZoomStyle, hamburgerSvg, closeSvg, Link$1 as Link, make };
