  ...
  return React.createElement("section", {
              ...
              id: "what-is-float"
                  ...
                  className: "flex flex-col items-center"
                      ...
                      className: "flex flex-row my-4 items-center justify-between max-w-5xl"
                    }, React.createElement("div", {
                          className: "w-1/2"
                        }, React.createElement("h3", {
                              className: "text-xl md:text-4xl flex flex-row items-center my-2 font-bold"
                            }, "Synthetic assets reimagined"), React.createElement("p", {
                              className: "text-md md:text-xl my-2"
                              ...
                              className: "my-2"
                                      ...
                                      className: "font-vt323 font-bold mr-2"
                                    }, ">"), "No slippage"), React.createElement("li", undefined, React.createElement("span", {
                                      className: "font-vt323 font-bold mr-2"
                                    }, ">"), "No fees"))))));
}
