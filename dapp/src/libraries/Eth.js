...
function get(value, unit) {
  if (unit.TAG === /* Eth */0) {
    ...
    return toFixedWithPrecisionNoTrailingZeros(Number(Web3Utils.fromWei(value, "ether")) * unit._0, unit._1);
  }
}
...
function toFixedWithPrecisionNoTrailingZeros$1(digitsOpt, eth) {
  ...
  return toFixedWithPrecisionNoTrailingZeros(Belt_Option.getWithDefault(Belt_Float.fromString(Web3Utils.fromWei(eth, "ether")), 0), digits);
}
